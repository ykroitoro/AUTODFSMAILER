...
#   root.destroy()
#   main(ans1, ans2)
# Single GUI window with buttons to replace the two original questions
...
# Icon
try:
    root.iconbitmap('MYTECH_LOGO.ico')
except Exception as e:
    print(f"Icon not found: {e}")

# Logo image
try:
    logo_image = Image.open('MYTECH_LOGO.png')
...
tk.Label(root, text="MY TECH LLC", font=("Arial", 24, "bold"), fg="white").pack(pady=20)
tk.Label(root, text="CHOOSE A COMBINATION TO PROCEED:", font=("Arial", 12, "bold"), fg="yellow").pack(pady=20)




tk.Button(root, text="PRICE - YES / DELETE COST - YES", width=30, command=lambda: run_with_answers("yes", "yes")).pack(pady=5)
tk.Button(root, text="PRICE - YES / DELETE COST -  NO", width=30, command=lambda: run_with_answers("yes", "no")).pack(pady=5)
tk.Button(root, text="PRICE -  NO / DELETE COST - YES", width=30, command=lambda: run_with_answers("no", "yes")).pack(pady=5)
tk.Button(root, text="PRICE -  NO / DELETE COST -  NO", width=30, command=lambda: run_with_answers("no", "no")).pack(pady=5)
