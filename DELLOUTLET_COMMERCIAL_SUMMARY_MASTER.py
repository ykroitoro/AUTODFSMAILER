...
df = pd.read_excel("Commercial List.xlsx")
...
df.to_excel("Dell Commercial List.xlsx", index=False)
...
df=PD.read_excel('Dell Commercial List.xlsx')

filename = ('DELLCOMMERCIAL.xlsx')
...
#SAVING FINAL FILE
wb.save('/Users/yosi/Desktop/DELLPROJECT/LISTS/DELL_COMMERCIAL_FACTORY_CERTIFIED_'+date_time_str+'.xlsx')


#DELETING UNNECESSARY FILES
file_path = "Dell Commercial List.xlsx"

if os.path.exists(file_path):
    os.remove(file_path)

file_path = "DELLCOMMERCIAL.xlsx"
