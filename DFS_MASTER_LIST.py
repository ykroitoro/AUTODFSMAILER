...
tk.Button(root, text="PRICE - ✔ / COST - X", width=30, command=lambda: run_with_answers("yes", "yes")).pack(pady=5)
tk.Button(root, text="PRICE - ✔ / COST - ✔", width=30, command=lambda: run_with_answers("yes", "no")).pack(pady=5)
tk.Button(root, text="PRICE - X / COST - X", width=30, command=lambda: run_with_answers("no", "yes")).pack(pady=5)
tk.Button(root, text="PRICE - X / COST - ✔", width=30, command=lambda: run_with_answers("no", "no")).pack(pady=5)
